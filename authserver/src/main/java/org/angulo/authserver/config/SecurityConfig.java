...
public class SecurityConfig {
    ...
    public RegisteredClientRepository registeredClientRepository() {
        RegisteredClient authCodeClient = RegisteredClient.withId(UUID.randomUUID().toString())
                .clientId("library-ms-client")
                .clientSecret("{noop}efwqggagasdgaergfbfqabg")
                ...
                .tokenSettings(TokenSettings.builder()
                        ...
                        .refreshTokenTimeToLive(Duration.ofHours(8)).reuseRefreshTokens(true)
            ...
            if (context.getTokenType().equals(OAuth2TokenType.ACCESS_TOKEN)) {
                context.getClaims().claims((claims) -> {
                    if (context.getAuthorizationGrantType().equals(AuthorizationGrantType.CLIENT_CREDENTIALS)) {
                        ...
                        Set<String> roles = authorityListToSet(context.getPrincipal().getAuthorities())
                                .stream()
